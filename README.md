...
J'ai à créer mes propres composants d'interface avec HTML et CSS afin d'avoir un rendu correspondant à la maquette.

Je dois également m'assurer que la page d'accueil fonctionne bien sur tous les appareils et tailles d'écran.
